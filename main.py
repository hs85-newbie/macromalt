...
def main() -> None:
    ...
    try:
        ...
        # ── Step 2A: Post 1 생성 ──────────────────────
        post1 = step_generate_analysis(news, research)
    ...
    try:
        # ── Step 2B: Post 2 생성 ──────────────────────
        post2 = step_generate_picks(post1, news, research)
