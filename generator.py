...
1. 사실: 출처가 있는 내용은 일반 문장으로 자연스럽게 서술
   ★ [Phase 21] 수치·통계 직후 인라인 출처 태그 필수:
     <small style="{_CITE_STYLE}">(출처명, YYYY.MM)</small>
     예: 영업이익 2,300억 원<small style="{_CITE_STYLE}">(메리츠증권, 2026.03)</small>
     예: 기준금리 3.5%<small style="{_CITE_STYLE}">(한국은행, 2026.02)</small>
     ※ 분기 실적·집계치·공식 발표 수치에 반드시 적용. 단 출처 불명 시 생략 가능.
...
□ ★ [Phase 21 인라인 출처 검수] 출처가 명확한 수치·통계 직후에 <small style="{_CITE_STYLE}">(출처명, YYYY.MM)</small> 태그가 삽입됐는가 — 본문에 최소 3개 이상 포함할 것
...
1. 사실은 일반 문장, 해석은 [해석], 전망은 [전망] 태그 필수
   ★ [Phase 21] 수치·통계 직후 인라인 출처 태그 필수:
     <small style="{_CITE_STYLE}">(출처명, YYYY.MM)</small>
     예: 영업이익 2,300억 원<small style="{_CITE_STYLE}">(메리츠증권, 2026.03)</small>
     ※ 종목 실적·목표가·수주잔고 등 구체 수치에 반드시 적용. 출처 불명 시 생략 가능.
...
□ ★ [Phase 21 인라인 출처 검수] 실적·수주잔고·목표가 등 구체 수치 직후에 <small style="{_CITE_STYLE}">(출처명, YYYY.MM)</small> 태그가 삽입됐는가 — 본문에 최소 2개 이상 포함할 것
□ [Phase 21 SEO_TITLE 검수] 출력 첫 줄이 <!-- SEO_TITLE: ... --> 형식 주석으로 시작하는가
