...
9. [★ 검수 이슈 내 날짜/수치 본문 삽입 금지]
   검수 이슈(issues) 텍스트에 포함된 날짜(예: "2024년 5월 20일 기준", "2024년 4월 15일 기준")나
   수치를 본문에 새로 삽입하지 말 것.
   수치 정확도 문제가 지적된 경우: 해당 수치를 삭제하거나, 원문 출처 기준 범위 표현(예: "최근")으로 대체하라.
   ❌ 금지: "2024년 5월 20일 기준 KOSPI는 2,724.62pt를 기록하고 있습니다"
   ✅ 허용: "(해당 데이터 삭제 또는) KOSPI는 해당 시점 기준으로 하락 마감했습니다"
"""
