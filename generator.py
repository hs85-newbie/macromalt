...
□ ★ "2026년", "연간", "가이던스", "전망치", "추정치"가 포함된 숫자가 [전망] 태그 없이 현재 사실로 단정 서술됐는가 (있으면 [전망] 태그 추가 또는 삭제)
□ ★ "유망", "주목해야 한다", "담아야 한다", "기회다", "추천", "매력적인 선택지" 등 투자 권유성 표현이 있는가 (있으면 분석형 문장으로 교체)
...
1. [시점 일관성] 다음 세 가지를 모두 확인한다:
   ...
   ③ ★ "2026년", "연간 가이던스", "FY전망치", "추정치" 등 미래 연도 숫자가
